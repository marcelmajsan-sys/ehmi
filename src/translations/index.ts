...
const en = {
  ...
  overview: {
    ...
    s6: {
      title: '6. Technology & Community',
      body: (s: S) => `${s.pctAI}% of respondents use AI tools in daily operations — primarily for content creation, product descriptions, and translations. ${s.pctCert}% have certified their webshop, and ${s.pctClan}% are active members of the eCommerce Hrvatska association.`,
      chart1: 'AI tool usage',
      chart2: 'AI tool use cases (top 8)',
      chart3: 'Webshop certification',
      chart4: 'Association membership',
    },
  },
  questions: {
    title: 'Questions',
...
const hr: typeof en = {
  ...
  overview: {
    ...
    s6: {
      title: '6. Tehnologija i zajednica',
      body: (s: S) => `${s.pctAI}% ispitanika koristi AI alate u svakodnevnom poslovanju — uglavnom za izradu sadržaja, opise proizvoda i prijevode. Certifikaciju webshopa provelo je ${s.pctCert}%, a ${s.pctClan}% je aktivni član udruge eCommerce Hrvatska.`,
      chart1: 'Korištenje AI alata',
      chart2: 'Za što se koriste AI alati (top 8)',
      chart3: 'Certifikacija webshopa',
      chart4: 'Članstvo u udruzi',
    },
  },
  questions: {
    title: 'Pitanja',
